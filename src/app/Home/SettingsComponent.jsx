      ...
      <div className="pb-20">
        <div className="relative   h-[400px]   ">
          <div className="bg-white centered-axis-x z-20 py-2 -top-10 h-fit w-[98%] rounded-lg relative">
            ...
            <div className="w-full max-w-screen justify-items-center   grid-cols-1 grid lg:grid-cols-2 gap-4">
              <div className="p-4">
                ...
                <div className="mt-4">
                  ...
                  <p>
                    <strong>Mobile:</strong> (+91) {restaurantinfo?.restaurantphoneNo}
                  </p>
                  <p>
            ...
            <button onClick={()=>changesection('personSearch')} type="button "  className="bg-orange-400 lg:text-base flex justify-center items-center space-x-2 capitalize font-semibold text-[#fff9ea] p-2  rounded-lg"><PersonAddAlt1Icon/><span>add waiter</span></button>
            <button type="button " onClick={()=>changesection('menuBook')}   className="bg-orange-400 flex justify-center items-center space-x-2 capitalize font-semibold text-[#fff9ea] p-2  rounded-lg"><EditNoteOutlinedIcon/><span>edit menu</span></button>
            </div>
